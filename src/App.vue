...
import axiosClient from './utils/axxios.ts';
import { Country } from  './models/country.models.ts';
...
<div class="mb-8 flex justify-center space-x-6">
  ...
  class="border border-gray-300 px-2  py-0.5 hover:bg-gray-200">Previous</button>
  <button
  
  :disabled="page >=  totalItems / itemsPerPage" 
  :class="{ 'opacity-50':page >=  totalItems / itemsPerPage}"
  @click="changePage(page + 1 )"
  class="border border-gray-300 px-2  py-0.5 hover:bg-gray-200"> Next</button>
